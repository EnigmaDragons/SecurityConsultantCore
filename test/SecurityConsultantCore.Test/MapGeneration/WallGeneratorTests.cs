...
//        [TestMethod]
//        public void WallGenerator_EmptyMap_NoWallsAdded()
//        {
//            _wallGenerator.GenerateWalls(_map);

//            Assert.IsFalse(_world.Objects.Any(x => x.Value.Any(y => y.Type.StartsWith("Wall"))));
//        }
